...
<section>
	<form class="searchBox">
		<div class="searchBox-wrap"><input type="tel" placeholder="车皮号/手机号" /></div>
		<div class="searchBox-label">搜索</div>
		<a href="buyPush.php" class="icon-bullhorn"> 发布</a>
	</form>
 ...
 //type = 1;
   if (type ==1){
    ...
    jstuffselect = document.getElementById("stuffselect").value;
	 url="getbuylist.php?"+"type=1&areaselect="+jareaselect+"&kindselect="+jkindselect+"&stuffselect="+jstuffselect+"&page="+page;
	}
   else {
	    jcarnumvalue =document.getElementById("carnum").value;
	  url="getbuylist.php?"+"type=2&carnum="+jcarnumvalue+"&page="+page;   
   }
